...
public class DatabaseConfig {
    ...
    static {
        try {
            ...
            // AWS JDBC Wrapper with Read/Write Splitting and IAM authentication
            ...
            config.setPoolName("AWSJDBCIamPool");

            dataSource = new HikariDataSource(config);

            log.info("AWS JDBC Wrapper with IAM Authentication initialized");
        } catch (IOException e) {
